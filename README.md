...
- [ ] Explain what a token is used for.
  ...
  a token is userd to verify the identity of the source of a request

- [ ] What steps can you take in your web apps to keep your data secure?

  not save your tokens in lolalStorage so they can be accessed by any javascript script

- [ ] Describe how web servers work.

  they serve data to clients through requests
